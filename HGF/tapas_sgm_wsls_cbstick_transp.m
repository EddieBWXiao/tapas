function [pvec, pstruct] = tapas_sgm_wsls_cbstick_transp(r, ptrans)
...
pvec(4)         = ptrans(4);         % wsbonus (no transformation)
pvec(5)         = ptrans(5);         % lsbonus (no transformation)

pstruct.ze      = pvec(1);
pstruct.bias    = pvec(2);
pstruct.stick   = pvec(3);
pstruct.wsbonus = pvec(4);
pstruct.lsbonus = pvec(5);
