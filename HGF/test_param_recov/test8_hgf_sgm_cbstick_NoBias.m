...
obs_config = tapas_sgm_cbstick_config();
...
obs_config.biasmu = 0;
obs_config.biassa = 0; % do not free the bias in this recovery attempt
...
pal_tapas_plotParRecAll(sims, fitted, ...
  {'p_obs.p(1)', 'p_prc.om(2)', 'p_prc.om(3)', 'p_obs.p(3)'}, ...
  {'logspace \zeta', '\omega_2', '\omega_3', 'choice stickiness'}, ...
  {@log, [], [], []});
